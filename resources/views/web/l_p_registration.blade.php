...
.candidate-signup-form input[type=text], .candidate-signup-form input[type=password], .candidate-signup-form input[type=number], .candidate-signup-form input[type=file], .candidate-signup-form input[type=email]
{
    margin: 5px 0 0px 0;
}
.candidate-signup-form p.password-para
{
    margin-top: -10px;
}
...
{
    .col-lg-6.col-md-6.col-sm-12.admin_user {
    top: 420px;
    display: contents;
    }
    ...
    #username-label , #labelpassword
    {
        margin-left: 15px;
    }
    .col-lg-6.col-md-6.col-sm-12.admin_user_password {
    top: 500px;
    display: contents;
    }
    .candidate-signup-form p.password-para {
...
.col-lg-9.col-md-9.col-sm-12.api-label {
    margin-top: 5%;
}
.candidate-signup-form img.api-img
{
    margin-top: 350px;
}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 admin_user_password">
                            <label for="psw" id="labelpassword"><b>Password</b></label>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 api-label">
                            <div class="form-group">
                                ...
                                <label for="agree">By clicking Register, you agree to our <a href="{{url('terms-conditions')}}" target="_blank">Terms & Conditions.</a> and <a href="{{url('privacy-policy')}}" target="_blank">Privacy-policy</a></label>
