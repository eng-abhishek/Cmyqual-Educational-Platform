...
<div class="mySlides">
  <p id="slideId">{{substr($all_activityData->category_name,0,30)}}</p>
</div>
@endforeach
...
@php 
      ...
      <a href="javascript:void(0)" onclick="viewgoal({{$goalOfStudentData['id']}})">View</a> 
...
<!-- 
        ...
        <button class="btn btn-primary" type="submit" style="margin-top: 75px;cursor:pointer;background-color: #1D9B75 !important">Submit</button>
        </div>
        </form>
        </div>
        </div>
