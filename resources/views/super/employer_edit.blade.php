        	...
        	<div class="row">
        		<div class="col-md-6 offset-md-3">
		            ...
		            <div class="card card-primary">
		              ...
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form id="quickForm" action="{{route('update-employer', $id)}}" method="post">
		              	@csrf
		                <div class="card-body">
		                  <div class="form-group">
		                    <label for="org_name">Organization Name<apan class="text-danger">*</apan></label>
                        <input type="text" class="form-control" name="org_name" value="{{str_replace(",", " ", $data->org_name)}}" id="org_name">
		                  </div>
		                  <div class="form-group">
		                    <label for="org_url">Organization Website (Optional)</label>
                        <input type="text" class="form-control" name="org_url" value="{{$data->org_url}}" id="org_url">  
		                  </div>
		                  <div class="form-group">
                        ...
                        <select class="form-control" name="role" required>
                            <option></option>
                            <option value="Hr"  <?php if($data->role == "Hr"){ echo "selected"; } ?> >Hr</option>
                            <option value="Recruiter"  <?php if($data->role == "Recruiter"){ echo "selected"; } ?>>Recruiter</option>
                        </select>  
		                  </div>
		                </div>
		                <!-- /.card-body -->
