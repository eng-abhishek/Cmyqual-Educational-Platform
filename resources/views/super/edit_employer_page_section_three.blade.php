...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Section 3</h1>
          </div>
        	...
        	<div class="row">
        		<div class="col-md-6 offset-md-3">
		            ...
		            <div class="card card-primary">
		              ...
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form id="quickForm" action="{{route('update-employer-section-three', $id)}}" method="post" enctype="multipart/form-data">
		              	@csrf
		                <div class="card-body">
						...
						<textarea name="para" class="form-control ckeditor" rows="4" >{{$data[0]->para}}</textarea>
