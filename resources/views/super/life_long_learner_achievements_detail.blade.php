                          ...
                          <table class="table table-bordered">
                                <tbody>
                                  ...
                                  <tr>
                                    <td><b>Issue by </b></td>
                                    @php
                                        $ib = substr($ach_data->Issued_by, 0, 30). PHP_EOL .substr($ach_data->Issued_by, 30)
                                    @endphp
                                    <td>{{$ib ? $ib : 'Not Found'}}</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td><b>Link </b></td>
                                    @php
                                        $l = substr($ach_data->link_to_course, 0, 30). PHP_EOL .substr($ach_data->link_to_course, 30, 30). PHP_EOL .substr($ach_data->link_to_course, 60) ;
                                    @endphp
                                    <td>{{$l ? $l  : 'Not Found'}}</td>
                                  </tr>
                                  <tr>
                                    <td><b>How long did it take? </b></td>
                                  ...
                                  <tr>
                                    <td><b>Type </b></td>
                                    <?php
                                    if($ach_data->achivementType=='edu'){
                                    $type="Education";    
                                    }elseif($ach_data->achivementType=='other'){
                                    $type="Other";
                                    }else{
                                        
                                    }
                                    ?>
                                    <td>{{$ach_data->achivementType ? $type : 'Not Found'}}</td>
                                  </tr>
                                  <tr>
                                    <td><b>Notes </b></td>
