...
.achievment-tree-list.add-new .tooltip.left .tooltip-arrow
{
  ...
  .achievment-tree-list.add-new .fa.fa-info-circle
  {
    position: absolute;
    z-index: 9;
    top: -20px;
...
360deg
  ...
  .change-career .fa.fa-info-circle
  {
    float:right;
  }
...
top: 5.1059%!important;
  ...
  .team-member-name .fa.fa-info-circle
  {
    float:right;
  }
  .change-career .fa.fa-info-circle {
...
.change-career h4.cc{margin-top:40px;}
  ...
  .achievement-box h4 .fa.fa-info-circle , .change-career.iac .fa.fa-info-circle
  {
    float: right;
  }
...
.share-achievement-list-program li
{
  margin-bottom:0px;
}
.select2-container--default .select2-selection--multiple{
...
Spread the word by inviting a friend or colleague and you both get a free one on one coaching session with our career experts.
</p>
...
<a href="#" class="btn btn-primary" type="button" data-toggle="modal" data-target="#inviteModal" style="cursor:pointer;background-color:  #1D9B75!important;border-radius:4px!important;text-transform:uppercase;padding-top: 10px;
    padding-bottom: 10px;border:none;">Invite</a>
</div>
</div>                              
 </div>
                                    <!-- <div class="col-md-4 col-sm-6">
...
<a href="#" data-toggle="tooltip" data-placement="right" title="What is this?- This shows you a list of your hard earned achievements that you’ve uploaded onto cMyqual so far. Click on Achievements on the  left panel on the page to edit, view or organise the achievements on this section"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
...
<div class="add-new-border" style="padding-top:6px !important"></div>
@endforeach
<div class="col-lg-12">
