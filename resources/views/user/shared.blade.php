...
<h5 style="font-size:14px">Shared Achievements<apan class="textdenger">*</apan></h5>
</div>

<div class="col-lg-8 col-md-8 col-sm-6 text-right" style="padding-right:0px">

<!-- <select class="achivementList"  id="select" multiple="true" required=""> 
...
<div class="col-lg-6 col-md-6 col-sm-6 text-right">
        <input type="checkbox" name="achivementList[]" value="{{$achivementInfoData->id}}" style="margin-right:10px">
...
<h5 style="font-size:14px">CPD Logs</h5>
</div>

<div class="col-lg-8 col-md-8 col-sm-6 text-right" style="padding: 15px;">

 <!-- <select class="cpdList"  id="select" multiple="true">  
...
<div class="col-lg-6 col-md-6 col-sm-6 text-right">
      <input type="checkbox" name="cpdList[]" value="{{$logInfoData->id}}" style="margin-right:10px">
