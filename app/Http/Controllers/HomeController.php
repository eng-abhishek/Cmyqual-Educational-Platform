...
class HomeController extends Controller
{
    ...
    {
        //echo '123';
		$productCate=Blog::orderBy('id','desc')->get();
		return view('website.blog',['category'=>$productCate]);
	...
	public function blog_detail($url)
    {
	   ...
	   $editData = DB::table('blogs')->where('url_slug',$url)->get();
	  
		
       return view('website.blog_details',['editData'=>$editData]);
    ...
    $url=url('product/'.$searchValue->url_slug);
