...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "{\"From\": \"SSUPLY\",\"To\": \"$contact_no,$admin_contact_no\",\"TemplateName\": \"For Booking SMS\", \"VAR1\": \"$name\", \"VAR2\":\"$orderId\"}",
));
