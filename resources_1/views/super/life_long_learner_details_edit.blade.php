                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="profile">
                    <form class="form-horizontal" action="{{route('learner-profile-edit-post')}}" id="quickForm1" method="post" enctype="multipart/form-data" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" name="dob" class="form-control" id="dob" max = "{{date('Y-m-d')}}" value="{{$stu_data->dob}}">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="tab-pane" id="education">
                    ...
                    @if(count($edu_data) != 0)
                      <div class="form-group row">
                        <div class="offset-sm-10 col-sm-2">
                          <p id="add" class="btn btn-primary" >Add Field</p>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane" id="work">
                    ...
                    <form class="form-horizontal" action="{{route('learner-profile-edit-work')}}" method="post" enctype="multipart/form-data">
                      @csrf
                      <input type="hidden" name="student_id" value="{{$stu_data->id}}">
                      <input type="hidden" name="user_id" value="{{$stu_data->user_id}}">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="File" class="form-control" name="cv" id="cv" placeholder="cv" accept=".xlsx,.xls,.doc,.docx,.ppt,.pptx,.txt,.pdf"  required>
                        </div>
                        <div class="col-sm-2">
