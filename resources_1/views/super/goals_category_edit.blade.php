...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Goals Category</h1>
          </div>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Goals Category</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        		...
        		<div class="col-md-6 offset-md-3">
		            ...
		            <div class="card card-primary">
		              <div class="card-header">
		                <h3 class="card-title">Edit Goal Category</h3>
		              </div>
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form id="quickForm" action="{{route('goals-category-edit-post', $data->id)}}" method="post">
		              	@csrf
		                <div class="card-body">
		                  <div class="form-group">
		                    <label for="org_name">Goal Category Name</label>
                        <input type="text" class="form-control" name="category" value="{{$data->category_name}}" id="category">
		                  </div>
		                </div>
		                <!-- /.card-body -->
