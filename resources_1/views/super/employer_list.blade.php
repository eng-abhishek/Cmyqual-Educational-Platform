                    ...
                    <thead>
                     <tr>
                      <th class="text-center">Sl.no</th>
                                            ...
                                            <th class="text-center">Organisation Url</th>
                    ...
                    <tbody>
                     @php $i=1; @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ str_replace(",", " ", $d->org_name)}}</td>
                                            <td class="text-center">{{ $d->org_url }}</td>
                                            <td class="text-center">{{ $d->role }}</td>
                                            <td class="text-center">{{ date("d M y", strtotime($d->created_at))}}</td>
                                            <td class="text-center"><a class="btn btn-sm btn-primary" href="{{route('edit-employer', $d->user_id)}}">Edit</a>&nbsp;<a class="btn btn-sm btn-danger" href="#" data-toggle="modal" data-target="#delModal{{$d->id}}">Delete</a></td>
                                        </tr>
                                        @php $i++; @endphp
                                        @endforeach
