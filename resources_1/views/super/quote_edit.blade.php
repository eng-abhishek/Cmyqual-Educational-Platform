          ...
          <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" action="{{route('quote-edit-post', $data->id)}}" method="post">
                    @csrf
                    <div class="card-body">
                      <div class="form-group">
                        <label for="org_name">Quote</label>
                        <input type="text" class="form-control" name="quote" value="{{$data->quote}}" id="quote">
                      </div>
                      <div class="form-group">
                        <label for="org_url">By</label>
                        <input type="text" class="form-control" name="by" value="{{$data->by}}" id="by">  
                      </div>
                    </div>
                    <!-- /.card-body -->
