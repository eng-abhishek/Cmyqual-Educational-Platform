...
<ul>
<li>
<label for="name" class=""><b>First Name</b></label>
<input type="text" placeholder="Enter your first name" class="control" name="f_name">
</li>
<li>
<label for="name" class=""><b>Last Name</b></label>
<input type="text" placeholder="Enter your last name" class="control" name="l_name">
</li>
<li>
...
confirm_pwd:{
 ...
 messages:{
  ...
  l_name:{
   ...
   dob:{
   required:'Please enter valide DOB',
   min:'Pleae enter valide date',
   }, 
   country:{
