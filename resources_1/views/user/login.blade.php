       ...
       <div class="demo-parallax parallax section looking-photo employer-registration-bg" data-stellar-background-ratio="0.7" style="background-image:url('upload/demo_04.jpg');display:none">
        ...
        <form class="candidate-signup-form" method="post" action="{{url('check-user-login')}}">
            ...
            <div class="col-lg-12">
                ...
                @if(session('error'))    
                <div class="col-lg-12">
                    <p style="font-size: 15px !important;text-align: center!important;color: red !important;"> Oops! There was a problem:</p>  
                    <p style="font-size: 15px !important;text-align: center!important;color: red !important;">- Email address and password not found.</p>
                    <p style="font-size: 15px !important;text-align: center!important;color: red !important;">Please try again or register.</p>
                </div>
                @endif
  ...
  <div class="modal fade" id="forgetPassModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content text-center">
        ...
        <input type="email" name="useremail" id="useremail" placeholder="hello@gmail.com" style="height: 30px;
    border-radius: 0;
    box-shadow: none;
...
<br><br>
<input type="number" name="reset_password_otp" id="otpbox" placeholder="Enter 4 digit OTP" style="height: 30px;border-radius: 0;box-shadow: none;
    background-color: #fff;
    border: 1px solid rgb(62 163 164 / 55%);
    padding: 0 10px;display:none">
  <button  type="button" id="verifyOTP" style="display:none;background: #1D9B75!important;padding: 3px 60px;text-transform: capitalize;font-family: 'Lato' ,sans-serif!important;border: none;color: #fff;margin-top: 10px;">verify OTP</button>
    <br><br>
...
alert('Please enter valid otp Verification Code'); 
