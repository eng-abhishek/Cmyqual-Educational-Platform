      ...
      <div class="modal-content shared-scroll">
        ...
        <ul>
          ...
          <input type="text" name="editId" id="editId"  hidden>
            ...
            <input type="text" placeholder="Enter Issued by" name="issuedBy" id="issuedBy" maxlength="50" minlength="2"><a><i class="fa fa-pencil-square-o a-pencil" aria-hidden="true"></i></a>
           </li>

           <li>
           <label for="link-to-course"><b>Link to course</b></label>
           <input type="url" placeholder="https://cmyqual.co.uk/" name="course_url" id="course_url" maxlength="500" minlength="5"><i class="fa fa-link a-link" aria-hidden="true"></i>
          </li>
