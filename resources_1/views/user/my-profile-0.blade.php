...
<div class="shared-search" style="margin-bottom:25%">
        ...
        <div class="modal-list modal-list-form">
         ...
         <ul>
           ...
           <li>
            ...
            <input type="text" placeholder="Enter Standard" name="standard" maxlength="50" minlength="1"><i class="fa fa-pencil-square-o a-pencil pencil1" aria-hidden="true"></i>
           </li>
          
          <li>
          <label for="hour" class="cpd-hour"><b>Hours</b></label>
          <input type="number" placeholder="5 Hours" name="hours" maxlength="5" min='0'><i class="fa fa-pencil-square-o a-pencil pencil1" aria-hidden="true"></i>
          </li>
          ...
          <input type="text" placeholder="Ex: Coding" style="margin-left: 15px !important;width: 83% !important;" name="tags" class="tags" maxlength="25" minlength="2">
          </li>
