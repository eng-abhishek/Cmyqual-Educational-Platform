...
<div class="col-lg-12 goal-box goal-box1 text-left">
    ...
    <a href="javascript:void(0)" onclick="removeAchievement({{$achivementInfoData->id}})" style="position: absolute;width: 30%;text-align:right;padding-right:10px;z-index: 1;">
