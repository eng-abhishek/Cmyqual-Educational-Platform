...
<div class="mySlides">
  <p id="slideId">{{$all_activityData->activity_name}}</p>
</div>
@endforeach
...
@php 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <button class="btn btn-primary" type="submit" style="margin-top: 45px;cursor:pointer;background-color: #1D9B75 !important">Submit</button>
        </div>
        </form>
        </div>
        </div>
