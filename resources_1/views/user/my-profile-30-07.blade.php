       ...
       <form method="post" action="{{url('add-shared-list')}}"> 
        ...
        <div class="tesla-box">
         ...
         <i class="fa fa-long-arrow-rigt" aria-hidden="true"></i></span>
           ...
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
           <label for="sent-invite" class="sent-invite"><b>Sent Invites</b><apan class="textdenger">*</apan></label>
           </div>
...
<div class="col-lg-8 col-md-8 col-sm-6" style="border: 1px solid rgb(62 163 164 / 55%)!important;width: 64.25%;">
      ...
      <div class="modal-content shared-scroll">
        ...
        <div class="modal-list modal-list-form">
         ...
         <ul>
            ...
            <input type="text" id="title" placeholder="Enter title" maxlength="35" minlength="2" name="title" style="margin-left:53px;" required>
            </li>
            <li>
            ...
            <input type="text" placeholder="Organization Name" maxlength="100" minlength="2" name="provider" required><!-- <i class="fa fa-pencil-square-o a-pencil pencil1" aria-hidden="true"></i> -->
           </li>
           <li>
            <label for="standard" class="provider"><b>Standards</b></label>
            <input type="text" placeholder="Enter Standards" name="standard" maxlength="50" minlength="1"><!-- <i class="fa fa-pencil-square-o a-pencil pencil1" aria-hidden="true"></i> -->
           </li>
          
          <li>
          <label for="hour" class="cpd-hour"><b>Hours</b><apan class="textdenger">*</apan></label>
          <input type="number" placeholder="5 Hours" name="hours" maxlength="5" min='0' required=""><!-- <i class="fa fa-pencil-square-o a-pencil pencil1" aria-hidden="true"></i> -->
          </li>
          ...
          <input type="text" placeholder="Ex: Coding" style="margin-left: 15px !important;width: 83% !important;" name="tags" class="tags" maxlength="25" minlength="2" required="">
          </li>
...
<!--           <input type="number" placeholder="12 Hours(max 15)" name="duration" maxlength="15" min="0" style="margin-left:30px">
 -->
          <input type="text" name="duration" style="margin-left: 30px;width: 83%;" maxlength="50" minlength="0">
