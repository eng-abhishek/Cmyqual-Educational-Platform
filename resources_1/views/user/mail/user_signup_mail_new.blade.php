							...
							<table class="col-600" width="600" height="auto" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color: #d0f2cf;">
								...
								<tr>
									<td align="left" style="line-height: 0px;">
										<img style="display:block; line-height:0px; font-size:0px; border:0px;padding-left: 10px;padding-bottom: 10px;" src="https://cmyqual.co.uk/assets/images/circle-logo.png" width="13%" height="auto" alt="logo">
									</td>
								</tr>
					...
					<tr>
						<td align="right">
							...
							<table width="287" border="0" align="left" cellpadding="0" cellspacing="0" class="col2" style="">
								<tbody><tr>
									<td align="center">
										<table class="insider" width="300" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left: 20px;">
											...
											<tr>
												<td align="right" style="line-height:0px;">
													<img style="display:block; line-height:0px; font-size:0px; border:0px;margin-right: 110px;
													margin-top: -25px;" class="images_style" src="https://cmyqual.co.uk/assets/images/template-get.png" width="20" height="auto">
												</td>
											</tr>
											<tr>
												<td height="15"></td>
											...
											<td align="left" style="line-height:0px;">
												<img style="display:block; line-height:0px; font-size:0px; border:0px;margin-right: 110px;
												margin-top: 0px;margin-bottom: -30px;" class="images_style" src="https://cmyqual.co.uk/assets/images/template-quality.png" width="20" height="auto">
											</td>
											<tr>
												<td align="justify" style="font-family: 'Montserrat', sans-serif; font-size:14px; color:#2a333a; line-height:24px; font-weight: 300;    padding-left: 25px;">
											...
											<tr><td align="left" style="line-height:0px;">
												<img style="display:block; line-height:0px; font-size:0px; border:0px;margin-right: 110px;
												margin-top: 50px;margin-bottom: -63px;" class="images_style" src="https://cmyqual.co.uk/assets/images/template-goal.png" width="20" height="auto">
											</td>
											</tr>
											<tr>
												<td align="justify" style="font-family: 'Montserrat', sans-serif; font-size:14px; color:#2a333a; line-height:24px; font-weight: 300;padding-left: 25px;padding-top: 40px;">
													2. Set a <strong>Goal.</strong> Kickstart your target-setting and begin tracking your development journey. Would you like help? Just email us on <strong>hello@cmyqual.com</strong> to get immediate support or have a chat with a coach. We highly recommend getting a 1:1 coaching session at first to enter more smarter goals. 
											...
											<tr><td align="left" style="line-height:0px;">
												<img style="display:block; line-height:0px; font-size:0px; border:0px;margin-right: 110px;
												margin-top: 15px;margin-bottom: -63px;" class="images_style" src="https://cmyqual.co.uk/assets/images/template-analysis.png" width="20" height="auto">
											</td>
											</tr>

											<tr>
												<td align="justify" style="font-family: 'Montserrat', sans-serif; font-size:14px; color:#2a333a; line-height:24px; font-weight: 300;padding-left: 25px;padding-top: 10px;">
					...
					<tr>
						<td>
							...
							<table class="col3" width="183" border="0" align="left" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td align="center">
										<table class="insider" width="200" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left: 20px;">
					...
					<tr>
						<td align="center" bgcolor="#5CCB9A" height="100">
							<table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td align="right" style="padding-right: 20px;font-family: 'Montserrat',  sans-serif; font-size:15px; font-weight: 600; color: #000;">Follow us on Social Media
									</td>
									</tr>
								<tr>
									<td align="left" style="padding-left: 20px;font-family: 'Montserrat',  sans-serif; font-size:12px; font-weight: 600; color: #000;">© <a href="https://cmyqual.co.uk/" style="color: #000;">cMyQual.co.uk </a>
									...
									<tr>
										<td align="left" style="padding-left: 20px;font-family: 'Montserrat',  sans-serif; font-size:12px; font-weight: 600; color: #000;">You received this email because you have signed up to <br>cMyQual.co.uk with this email address</a>
								...
								">
									...
									<td align="center" width="30%" style="vertical-align: top;    padding-right: 20px;">
