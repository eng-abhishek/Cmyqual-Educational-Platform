...
<tbody>
<tr>
<td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:600;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:30px;line-height:42px;padding:0px 0px;padding-bottom:0px;word-break:normal;direction:ltr" align="center" width="100%">Congratulations!</td>
</tr>
</tbody>

<tbody>
  <tr>
  <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:600;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:30px;line-height:42px;padding:0px 0px;padding-bottom:0px;word-break:normal;direction:ltr" align="center" width="100%">{{$user_name}} invited you to try cMyQual for free
</td>
  </tr>
</tbody>
<tbody>
  <tr>
  <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:400;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:16px;line-height:42px;padding:0px 0px;padding-bottom:5px;word-break:normal;direction:ltr" align="center" width="100%">Please click the button below to join cMyQual
</td>
  </tr>
</tbody>
<tbody><tr>
  <td style="Margin-top:0;Margin-bottom:0;Margin-right:0;Margin-left:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:left" align="left">
    <img src="https://cmyqual.co.uk/assets/images/envelope.png" width="200px" height="auto" style="outline:none;text-decoration:none;display:block!important;margin:0 auto" class="CToWUd">
  </td>
...
<tbody>
  <tr>
  <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:400;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:16px;padding-top: 30px;line-height:20px;padding:20px 0px 0 0;padding-bottom:5px;word-break:normal;direction:ltr" align="center" width="100%">cMyQual is the ultimate career management tool that would help you grow your career! CMyQual is an aggregate of your earned certificates, qualifications and continued learning hours. Using our simple interface, you can track and maintain a dashboard of your professional assets. You can share this dashboard with future employers, clients or anyone you need to or want to.

   <a href="https://cmyqual.co.uk/">Visit our website</a> for more information
   </td>
  </tr>
  <tr>
    <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:400;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:16px;padding-top: 0px;line-height:20px;padding:0px 0px 0 0;padding-bottom:5px;word-break:normal;direction:ltr" align="center" width="100%">
      <b>No longer will one’s future be derailed because of a lost certificate!</b>
     </td>
    </tr>
</tbody>
</table>
