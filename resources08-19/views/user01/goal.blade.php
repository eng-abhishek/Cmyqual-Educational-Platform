...
@media(max-width:414px)
{
  ...
  body.leftmenu #wrapper.toggled #page-content-wrapper .modal-list ul li #goalname {
    margin-left: 0px!important;
    width: 100%!important;
}
      ...
      <div class="modal-content">
        ...
        <li>
          <label for="goal"><b>Goal Name</b></label>
            <input type="text" name="goalname" id="goalname" placeholder="Enter Goal Name" maxlength="35" minlength="3" style="margin-left: 53px;width: 83%;padding: 5px 10px 5px 10px;border: none;background: #fff;border: 1px solid rgb(62 163 164 / 55%);" required>
        ...
        <li>
        <label for="activity" class="issued-by"><b>Expected Completion Date</b></label>
        <input type="date" name="cmp_date" min="{{date('Y-m-d')}}" id="cmp_date" placeholder="Enter Date of complition" style="margin-left: 53px;width: 71%;padding: 5px 10px 5px 10px;border: none;background: #fff;border: 1px solid rgb(62 163 164 / 55%);">
        </li> 
<!-- 
        <li>
