...
<head>
    ...
    <!-- SITE META -->
    <title>cMyQual | Learning Partner Login</title>
    ...
    ********************************************** -->
    ...
    @include('web.header')
       ...
       <div class="demo-parallax parallax section looking-photo employer-registration-bg" data-stellar-background-ratio="0.7" style="background-image:url('upload/demo_04.jpg');display:none">
        ...
        <form class="candidate-signup-form" method="post" action="{{route('partner-login-post')}}">
            <div class="container">
            <div class="row">
            <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <button type="submit" class="signupbtn" name="btnUserLogin">Login</button>
                              <a href="{{ route('l-p-signin') }}"><button type="button" class="signupbtn register-btn" name="btnUserLogin">Register</button></a>
                </div>
                ...
                <div class="col-lg-12 lost-a-detail-col">
                    ...
                    <p class="new">
                        New to CMyQual?
                        <a href="{{ route('l-p-signin') }}">Sign up Now</a>
                    </p>
                </div>
               ...
               <div class="login-box">
                   <h4><a alt=""><img src="{{asset('assets/images/socmed_icon_go.png')}}" style="margin-top:0px" alt=""> Google</a></h4>
               </div>
               </div>
               <div class="col-lg-4 col-md-4 col-sm-4 text-center">
                <div class="login-box">
                    <h4><a ><img src="{{asset('assets/images/socmed_icon_fb.png')}}" alt=""> Facebook</a></h4>
                </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 text-center">
                    <div class="login-box">
                        <h4><a alt=""><img src="{{asset('assets/images/socmed_icon_li.png')}}" alt=""> Linkedin</a></h4>
                    </div>
                </div>
