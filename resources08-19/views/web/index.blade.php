...
<div class="container">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="content">
       <span>{{$datatwo[0]->heading}}</span>
        <h3>{{$datatwo[0]->subheading}}</h3>
        <p>{{$datatwo[0]->para}}</p>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="content">
        <span>{{$datathree[0]->heading}}</span>
        <h3>{{$datathree[0]->subheading}}</h3>
        
		{!! substr($datathree[0]->para,0,250) !!}
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="content">
        <span>{{$datafour[0]->heading}}</span>
        <h3>{{$datafour[0]->subheading}}</h3>
        <p>{{$datafour[0]->para}}</p>
