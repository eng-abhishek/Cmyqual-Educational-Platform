                  ...
                  <div class="active tab-pane">
                    <form class="form-horizontal" action="{{route('learner-achievements-add-post')}}" id="quickForm1" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" class="form-control" accept="image/jpeg,image/png,.pdf" name="image" id="file">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input required type="month" class="form-control" name="issued" id="issued" max="<?php echo date('Y-m');?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <span class="text-danger">Note: Should not before Issue date.</span>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <!--  @endfor-->
                          <!--</select>-->
                          <input type="text" class="form-control" name="duration" id="duration" maxlength="50" minlength="0">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" name="credit" id="credit" min="1" maxlength="10">
                        </div>
                      </div>
