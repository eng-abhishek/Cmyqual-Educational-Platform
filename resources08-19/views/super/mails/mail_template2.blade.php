                        ...
                        <td style="border-collapse:collapse;font-family:'Roboto',Arial,Helvetica,sans-serif;padding:0;background-color:#ffffff">
                           <table role="Presentation" style="width:600px;border:0 none;border-collapse:collapse" border="0" cellpadding="0" cellspacing="0" width="600">
                              <tbody>
                                                         ...
                                                         <tr>
                                                            <td style="border-collapse:collapse;font-family:'Roboto',Arial,Helvetica,sans-serif;padding:25px 40px 0px 40px" width="100%">
                                                               <table role="Presentation" style="border:0 none;border-collapse:collapse" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                  <tbody>
                                                                     <tr>
                                                                        <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:600;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:20px;line-height:42px;padding:0px 0px;padding-bottom:0px;word-break:normal;direction:ltr" align="center" width="100%">Welcome to cMyQual</td>
                                                                     </tr>
                                                                  </tbody>
                                                                  <tbody>
                                                                     <tr>
                                                                        <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:600;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:30px;line-height:42px;padding:0px 0px;padding-bottom:25px;word-break:normal;direction:ltr" align="center" width="100%">Please verfiy your email</td>
                                                                     </tr>
                                                                  </tbody>
                                                                  <tbody>
                                                                     <tr>
                                                                        <!-- <td style="Margin-top:0;Margin-bottom:0;Margin-right:0;Margin-left:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:left" align="left">
                                                                           <img src="https://cmyqual.co.uk/assets/images/check-icon.png" width="200px" height="auto" style="outline:none;text-decoration:none;display:block!important;margin:0 auto" class="CToWUd">
                                                                           </td> -->
                                                                        <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:400;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:16px;padding-top: 30px;line-height:20px;padding:0px 0px;padding-bottom:0px;word-break:normal;direction:ltr" align="center" width="100%">
                                                                           <span style="color:#3c4043!important">Your verification code is below:</span>   
                                                                           <p style="color:black;font-weight: 600;font-size: 18px;">{{$otp}}</p>
                                                                        </td>
                                                                     </tr>
                                                                  </tbody>
                                                                  <!-- <tbody>
                                                                     <tr>
                                                                     <td dir="ltr" style="border-collapse:collapse;color:#3c4043;font-weight:400;font-family:'Google sans','Roboto',Arial,Helvetica,sans-serif;font-size:16px;padding-top: 30px;line-height:20px;padding:0px 0px;padding-bottom:25px;word-break:normal;direction:ltr" align="center" width="100%">Please click the button below to verify your email address and complete your registration.
                                 ...
                                 <tr>
                                    <td>
                                       <table role="Presentation" style="border:0 none;border-collapse:collapse;margin-top:24px" border="0" cellpadding="0" cellspacing="0">
                                          <tbody>
                                             <tr>
                                                <td style="border-collapse:collapse;color:#5f6368;font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:16px;text-align:left;line-height:26px;direction:ltr;padding:0px 40px 0px 40px;word-break:normal" valign="top" width="93%" dir="ltr">Portal Link - <a href="https://cmyqual.co.uk" style="color:#1D9B75">https://cmyqual.co.uk</a></td>
                                             </tr>
                                          </tbody>
                                       </table>
                                    </td>
                                    ...
                                    <td style="border-collapse:collapse;font-family:Roboto,sans-serif;padding:30px 40px;border-top: 1px solid #1D9B75!important" align="center" bgcolor="#ffffff" valign="top" width="100%">
                                       <table role="Presentation" style="border:0 none;border-collapse:collapse" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                          <tbody>
                                             ...
                                             <tr>
                                                <td colspan="2" style="border-collapse:collapse;color:#444444;font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:10px;direction:ltr;line-height:14px;padding:0 0 12px;padding-bottom:0;word-break:normal" align="center" valign="top" width="100%">
