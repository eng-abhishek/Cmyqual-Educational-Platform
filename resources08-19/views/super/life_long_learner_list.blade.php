                                        ...
                                        <tr>
                                            ...
                                            <td style="">{{$name ? $name : 'Not Found'}}<br>
                                              @php
                                                ...
                                                $check_cpd = \App\Models\Cpdlog::where('student_id', $d->id)->where('is_viewed', 0)->count();
                                                $check_sh = \App\Models\Shared_list::where('student_id', $d->id)->where('is_viewed', 0)->count();
                                                if($check_ach > 0 || $check_goal > 0)
                                                {
                                                  $total=$check_ach+$check_goal+$check_cpd+$check_sh;
                                                  if($total > 0)
                                                  {
