...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Home Page Section 4</h1>
          </div>

          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item ">Dashboard</li>
               <li class="breadcrumb-item active">Home Page Section 4</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <tbody>
                     @php $i=1; @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a class="btn btn-sm btn-primary" href="{{route('edit-employer-page-section-four', $d->id)}}">Edit</a>&nbsp;</td>
                                        </tr>
                                        @php $i++; @endphp
                                        @endforeach
