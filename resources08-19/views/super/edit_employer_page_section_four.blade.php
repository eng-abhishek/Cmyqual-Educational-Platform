...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Section 4</h1>
          </div>

          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item ">Dashboard</li>
              <li class="breadcrumb-item">Section 4</li>
        	...
        	<div class="row">
        		<div class="col-md-6 offset-md-3">
		            ...
		            <div class="card card-primary">
		              ...
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form id="quickForm" action="{{route('update-employer-section-four', $id)}}" method="post" enctype="multipart/form-data">
		              	@csrf
		                <div class="card-body">
                        ...
                        <input type="text" class="form-control" name="heading" value="{{ $data[0]->heading }}" id="org_name">
						  ...
						  <div class="form-group">
		                    <label for="org_name">Sub Heading<apan class="text-danger">*</apan></label>
                        <input type="text" class="form-control" name="subheading" value="{{ $data[0]->subheading }}" id="org_name">
						...
						<textarea name="para" class="form-control" rows="4" >{{$data[0]->para}}</textarea>
