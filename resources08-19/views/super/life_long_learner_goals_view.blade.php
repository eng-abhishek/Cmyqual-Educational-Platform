                    ...
                    <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                      <div class="row">
                        ...
                        @php 
                          ...
                          {
                            $b = round($a/$total_activity_count, 2);
                          }
                          else
                          {
                            $b = 0;  
                        ...
                        <div class="col-12 col-sm-4">
                          ...
                          <div class="info-box bg-primary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text" style="font-weight: 700;">{{$string ? substr($string, 0, 15) : 'Not found'}}
                                @if($goal->is_viewed == 0)
                              ...
                              @php
                                      $category = App\Models\Goals_category::find($goal->category_id);
                                    @endphp
                              <span class="info-box-number" style="font-weight: 100;">{{substr($category->category_name,0,15)}}</span>
                              <div class="progress">
